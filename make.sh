...
g++ -Wall -std=c++11 suinput.c joystick.cc CKeyboard.cc LuaScript.cc CVirtualJoy.cc CVirtualKeyboard.cc linuxtrack.c -o wejoy main.cc -ludev -lpthread -lX11 -llua5.2
